...
const gatherVideo = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (fs.existsSync(_subs)) {
        fs.openSync(_subs, 'r');
        return { video: _path, subs: yield fs.readFileSync(_subs, "utf8") };
    }
    else
        return { video: _path, subs: "" };
});
const createWindow = () => {
    ...
    electron_1.ipcMain.on("startup", (event, args) => __awaiter(void 0, void 0, void 0, function* () {
        mainWindow.webContents.send('startup', yield gatherVideo());
    }));
    electron_1.ipcMain.on("opensubtitles", (event, args) => __awaiter(void 0, void 0, void 0, function* () {
        var location = '';
        yield electron_1.dialog.showOpenDialog({
